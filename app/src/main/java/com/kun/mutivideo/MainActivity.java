...
//    };
    String[] uris={
        "sp1.3gp","sp2.3gp","sp3.3gp","sp4.3gp"//,"sp5.3gp","sp6.3gp","sp7.3gp","sp8.3gp"
};
//    String[] uris={
//            "20160718_182714.mp4","20160718_180217.mp4",
//        "20160718_173310.mp4","20160718_151839.mp4",
//        "20160225_184804.mp4","20160225_184537.mp4",
//        "20160225_183732.mp4","20160225_183715.mp4"
//    };
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String url=path+uris[finalI];
                        mMediaPlayers[finalI].setDataSource(url);
                            ...
                            public void onPrepared(MediaPlayer mp) {
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        mMediaPlayers[finalI].setLooping(true);
                                    }
                                });
                            }
                        });
